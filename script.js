// Skeletin screen ui shown for 3 seconds
setTimeout(() => {
  document
...
function checkScroll() {
  ...
  let newSize = 3 - scrollPosition * 0.003; // Decrease by 0.03 rem for every 1px scrolled
...
// Initialize theme when script lodas
initializeTheme();
